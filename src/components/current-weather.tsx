...
const CurrentWeather = ({dataWeather, location}: Props) => {
  const {
        ...
        <div className="grid gap-6 grid-cols-2">
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="relative flex aspect-square w-full max-w-[200px] items-center justify-center">
              <img src={`https://openweathermap.org/img/wn/${currentWeather.icon}@4x.png`} alt={currentWeather.description} className="h-full w-cull object-contain"/>
